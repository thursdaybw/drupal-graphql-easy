...
/**
 * @DataProducer(
 *   id = "im_query_hierarchical_entities",
 ...
 * )
 */
class QueryHierarchicalEntities extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function resolve(string $entity_type, ?array $sort, ?string $filter, RefinableCacheableDependencyInterface $metadata) {
